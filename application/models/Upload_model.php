...
/*		
    ...
    public function initialize($options = null, $initialize = true, $error_messages = null) {
        
		
        $this->options = array(
            'script_url' => $this->get_full_url().'/',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/assets/products/',
            'upload_url' => $this->get_full_url().'/assets/products/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
