...
margin-right:-100px;
 ...
 #map-side{width: 100%; min-height:400px}
   ...
   <!-- Part 1: Wrap all content here -->
    <div id="wrap">
      ...
      <!-- Begin page content -->
       <div class="container" id="home_container">
		 ...
		 <div class="row-fluid">
             ...
             <h1 class=" text-center"> FIND <span class="na_script yellow big_icon"><?php echo $businessT;?></span> IN <span class="na_script big_icon"><?php echo $locationT;?></span></h1>
			 <?php 
             //+++++++++++++++++
             //LOAD HOME SEARCH BOX
             //+++++++++++++++++
             
             $this->load->view('business/inc/filter');
         ...
         <div class="row-fluid">
             ...
             <div class="span4">
                 <div class="btn-group pull-right">
                      ...
                      <input name="catM" id="categoryM" type="hidden" value="<?php if($catM){ echo $catM;}else{ echo '0';}?>"/>
                      <input name="locM" id="locationM" type="hidden" value="<?php if($locM){ echo $locM;}else{ echo '0';}?>"/>
                 	  <input name="busM" id="businessM" type="hidden" value="<?php if($busM){ echo $busM;}else{ echo '0';}?>"/>
                 	   <?php //MAIN CATEGORY SEARCH ?>
                      <input name="MAINlocM" id="MAINlocM" type="hidden" value="<?php if($MAINlocM){ echo $MAINlocM;}else{ echo '0';}?>"/>
                 	  <input name="MAINcatM" id="MAINcatM" style="padding:11px;" type="hidden" value="<?php if($MAINcatM){ echo $MAINcatM;}else{ echo '0';}?>"/>
                      <button id="btn_list_view" style="margin-right:5px" class="btn btn-inverse disabled"><i class="icon-list icon-white"></i> List View</button>
                      <button id="btn_map_view" class="btn btn-inverse"><i class="icon-map-marker icon-white"></i> Map View</button>
                      </form>
                </div>
             </div>
        </div>
        ...
        <div class="row-fluid">
           <div class="span12">
               <ul class="breadcrumb btn-inverse">
                   <?php $this->search_model->show_categories_breadcrumb($main_c_id, $main_category, $c_id, $category, $l_id, $location, $business);
        ...
        <div class="row" style="min-height:500px;">
                ...
                <div class="span4">
                          ...
                          <button type="button" id="sort_desc" class="btn btn-inverse<?php if($sortby == 'DESC'){ echo ' active';}?>"><i class="icon-arrow-up icon-white"></i> Z - A</button>
                          <button type="button" id="sort_asc" class="btn btn-inverse<?php if($sortby == 'ASC'){ echo ' active';}?>"><i class="icon-arrow-down icon-white"></i> A - Z</button>
                          <button type="button" id="sort_rate" class="btn btn-inverse<?php if($sortby == ''){ echo ' active';}?>"><i class="icon-star icon-white"></i></button>
                        </div>
                        <div class="clearfix" style="height:20px;"></div>
                   
                    
                    <div class="hidden-phone white_box padding10 affix-top" data-spy="affix" data-offset-top="300">
                        <div id="map-side"></div>
                        <div id="side_bar" class="container-fluid" style="height:0px;">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;
     ...
     <div class="container-fluid fullwidth hide" id="map_container">
         ...
         <div class="row-fluid">
             <div class="span4" id="map_results_div">


             </div>
             <div class="span8">
                 <button id="btn_list_view2" class="btn btn-inverse hide"><i class="icon-list icon-white"></i> List View</button>
                 <div id="map-top"></div>
