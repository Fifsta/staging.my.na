      ...
      <!-- Begin page content -->
       <div class="container" id="home_container">
        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                <h1><?php echo $SPECIALS_HEADER;?> <small> </small></h1>
                <ul class="breadcrumb btn-inverse">
                    <?php $this->deal_model->show_deals_breadcrumb($cat = '', $MAP_LOCATION, $key = '');?>

                    <li itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><span class="divider">/</span><a class="label label-warning" href="<?php echo current_url('/');?>'" itemprop="url"><span itemprop="title"><?php echo $SPECIALS_HEADER;?></span></a></li>
                </ul>
            </div>
        ...
        <div class="row">
				...
				*/
				...
				?> 
				 <div class="span9">
                 <div id="deal_content" class="" style="min-height:400px;width:100%">
					<?php 
                        /*
                        SHOW single deal
                        */	
                                
                          echo $this->deal_model->show_deal($ID);
					...
					<div class="white_box padding10">
                    	<div class="row-fluid">
                        	<div class="span8">
                                <h4>The Deal</h4>
                                <?php echo $SPECIALS_CONTENT; ?>
                                <p style="font-size:11px; font-style:italic">* Terms and Conditions Apply</p>
                            </div>
                            <div class="span4">
                            	<div class="alert alert-success text-center">
                                    <h3>SAVE <small style="font-size:8px">N$ </small><?php echo ($NORMAL_PRICE - $SPECIALS_PRICE); ?></h3> 
                            	
                                 </div>
                                 <div class="alert text-center">
                                    <h3>DEAL CLAIMED <?php echo $this->deal_model->count_claims($ID);?><font style="font-size:20px"> x</font></h3> 
                            	
                                 </div>
                                 <div class="alert text-center">
                                    <h3>UNSURE <font style="font-size:20px"> ?</font></h3> 
                            		
                                 </div>
                                 <a href="<?php echo site_url('/').'b/' .$BUSINESS_ID.'/contact';?>" class="btn btn-inverse btn-block"> Contact Business</a>
                            </div>
                        </div>	
...
function load_home_feed(){
		...
		$.ajax({
			type: 'get',
			cache: false,
			url: '<?php echo site_url('/').'deals/load_single/' .$ID;?>' ,
			success: function (data) {	
