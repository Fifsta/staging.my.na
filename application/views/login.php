...
<body>
    ...
    <div id="wrap" style="padding-top:0;width:100%;height:100%;bottom:0; min-height:100%;">
        ...
        <div class="fb-login-button float-right" data-max-rows="1" data-size="large" data-show-faces="false" data-scope="email" onlogin="checkLoginState()" style="margin-top:-5px;padding:10px 0;" data-auto-logout-link="false"></div>
        <div class="clearfix">&nbsp;</div>
           <p>
               <a href="<?php echo site_url('/');?>members/register/" class="">No Account? Create one now.</a>
           </p>
           <p>
             <small><a href="javascript:void(0)" onClick="pass_update()" class="float-right">Forgot Password?</a>
               <a href="<?php echo site_url('/');?>page/terms-and-conditions/" class="float-left">My Na Terms</a>
             </small>
           </p>
        </div>
        </div>   
      ...
      <div class="tab-pane <?php if(isset($pass_update)){ echo '';}else{ echo 'd-none';}?>" id="pass_update">
        <?php echo form_open(site_url('/').'members/pass_update_one', array('class' => 'form-signin white_box', 'name' => 'formpass0'));?>   
          ...
          <small><a href="javascript:void(0)" onClick="login_update()" class="float-right">Login?</a>
            <a href="<?php echo site_url('/');?>page/terms-and-conditions/" class="float-left">My Na Terms</a>
          </small>
        </form>
      </div>
 ...
 <div id="anchor"></div>     
  ...
  <script type="text/javascript">
    ...
    function login_update(){
      ...
      $('#pass_update').addClass("d-none");
      $('#form_login').addClass("d-block");
