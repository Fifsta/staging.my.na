	         ...
	         <div class="col-md-12">
	            ...
	            <div id="deal_content">
	              ...
	              */  
	              ...
	              $this->trade_model->get_agency_products($bus_id,$query, $main_cat_id = 0, $sub_cat_id = 0, $sub_sub_cat_id = 0, $sub_sub_sub_cat_id = 0, $count = 15, $offset = 0, $title = '',$amt = 4, $advert = FALSE);
