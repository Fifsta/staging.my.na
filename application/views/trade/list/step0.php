...
<div class="col-md-12">
  <div class="row text-center">
    ...
    <div class="col-md-2 card">
      <div class="card-body">
          <img src="<?php echo base_url('/');?>images/buttons/job.jpg" class="job"/>
          <p>
            <div class="clearfix" style="height:5px;"></div>
            <div style="font-size:13px;margin-bottom:10px;">List a Job position available, Careers &amp; Vacancies</div>
            <div><a href="javascript:void(0)" onclick="go_step_1('job');" class="btn btn-block btn-dark disabled"> Coming Soon</a></div>
          </p>
        </div>
    </div>
