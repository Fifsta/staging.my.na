        ...
        <div class="col-sm-8 col-md-8 col-lg-9 col-xl-8 order-md-1 order-sm-2">
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="heading">
                            <h2 data-icon="fa-list">List an <strong>Item</strong></h2>
                            <ul class="options">
                        ...
                        <p>Please select if you want to proceed listing a product privately or under a business.</p>
                            ...
                            if($step == 'step0'){
                                ...
                                if($type == 'auction'){
                                    $head = '<h1>Create an Auction as</h1>';
                                    $type_str = '&type=auction';

                                }elseif($type == 'motor'){
                                    $type_str = '&type=motor';
                                    $head = '<h1>List Anything Automotive as</h1>';

                                }elseif($type == 'property'){
                                    $type_str = '&type=property';
                                    $head =  '<h1>List a Property as</h1>';

                                }elseif($type == 'service'){
                                    $type_str = '&type=service';
                                    $head =  '<h1>List a Business Service as</h1>';

                                }else{
                                    $type_str = '&type=general';
                                    $head = '<h1>List an Item as</h1>';
                                ...
                                echo '<div class="col-md-6">'.$this->my_na_model->get_businesses($bus_id, $typestr ='',  $type = $type_str).'</div>';
                            ...
                            <div class="row <?php echo $next_hide;?>" id="admin_content">
