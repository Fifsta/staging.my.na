...
<div class="control-group">
  <label class="control-label" for="model"><strong>Model</strong></label>
  <div class="controls">
      ...
      <span class="help-block"  style="font-size:11px">What model is the item? eg: GS, YZ 250</span>
  </div>
</div>
<br>
...
<div class="control-group">
  ...
  <div class="controls">
      <select class="form-control" name="transmission" data-placeholder="Please Select" class="extra_slect form-control">
      ...
      <span class="help-block"  style="font-size:11px"> What transmission is the motorbike</span>
  </div>
</div>
<br>
...
<div class="control-group">
  ...
  <div class="controls">
      <select class="form-control" name="owners" data-placeholder="Please Select" class="extra_slect form-control">
      ...
      <span class="help-block"  style="font-size:11px">How many people have owned the motor bike</span>
  </div>
</div> 
<br>
