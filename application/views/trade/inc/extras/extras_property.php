...
//+++++++++++++++++++++++++++
    ...
    ?>
                                      ...
                                      <div class="control-group">
                                          <?php //echo $main_cat_id. ' > '.$sub_cat_id. ' > '.$sub_sub_cat_id. ' > '.$sub_sub_sub_cat_id;?>
                                      <label class="control-label" for="location">Address</label>
                                           <div class="controls">
                                                <input id="pac-input" style="position:relative"name="address" type="text" value="<?php test_extras_output($existing ,'location', $product_id,  'output');?>" placeholder="32 Sam Nujoma Drive Windhoek Namibia">
                                      ...
                                      <div class="control-group">
                                        ...
                                        <div class="controls">
                                                ...
                                                <div id="map-canvas" style="min-width:100%; min-height:100%" class="img-polaroid  loading_img"></div>
                                      ...
                                      <div class="control-group">
                                       <label class="control-label" for="toggle_map">Show Map</label>
                                            <div class="controls">
                                      ...
                                      <div class="control-group">
                                        <label class="control-label" for="valuation">Valuation</label>
                                        <div class="controls">
                                                <input type="text"  value="<?php test_extras_output($existing['extras'] ,'valuation', $product_id,  'output');?>" onkeypress="return isNumberKey(event)" name="valuation" placeholder="N$">
                                      ...
                                      <div class="row-fluid">
                                        ...
                                        <label class="control-label" for="sole_mandate">Sole Mandate</label>
                                            <div class="controls">
												<input type="checkbox" name="sole_mandate" value="Sole Mandate" <?php test_extras_output($existing['extras'] ,'sole_mandate', $product_id,  'checked');?>>
                                      	...
                                      	<div class="span4">
                                            ...
                                            <div class="controls">
												<input type="checkbox" name="cc_registered" value="cc Registered" <?php test_extras_output($existing['extras'] ,'cc_registered', $product_id,  'checked');?>>
                                            </div>
                                        </div>
                                      	<div class="span4">
                                        <label class="control-label" for="PTY_Ltd">PTY (Ltd)</label>
                                            <div class="controls">
												<input type="checkbox" name="PTY_Ltd" value="PTY (Ltd)" <?php test_extras_output($existing['extras'] ,'PTY_Ltd', $product_id,  'checked');?>>
                                      ...
                                      <div class="row-fluid">
                                      	<div class="span4">
                                            <label class="control-label" for="vat_inclusive">Vat inclusive</label>
                                            <div class="controls">
                                                <input type="checkbox" name="vat_inclusive" value="Vat Inclusive" <?php test_extras_output($existing['extras'] ,'vat_inclusive', $product_id,  'checked');?>>

                                            </div>
                                        </div>
                                      	<div class="span4">
                                            <label class="control-label" for="negotiable">Negotiable</label>
                                            <div class="controls">
												<input type="checkbox" name="negotiable" value="Negotiable" <?php test_extras_output($existing['extras'] ,'negotiable', $product_id,  'checked');?>>
                                            </div>
                                        </div>
                                    
                                      	<div class="span4">

                                              <label class="control-label" for="transfer_costs_included">Transfer Costs included</label>
                                              <div class="controls">
                                                  <input type="checkbox" name="transfer_costs_included" value="Sole Mandate" <?php test_extras_output($existing['extras'] ,'transfer_costs_included', $product_id,  'checked');?>>
									...
									?>	 
                                     ...
                                     <?php //} ?>
                                      ...
                                      <div class="row-fluid">
                                          <div class="span6">
                                              <label class="control-label" for="offices">Offices</label>
                                              <div class="controls">
                                                  <select class="" name="offices">
                                                      <option value="">Select if Relevant</option>
                                          ...
                                          <div class="span6">
                                              <label class="control-label" for="garages">Garages</label>
                                              <div class="controls">
                                                  <select class="" name="garages">
                                                      <option value="">Select if Relevant</option>
                                      ...
                                      ?>
                                          <div class="control-group">
                                              ...
                                              <div class="controls">
                                                  <input type="text" name="farm_size" onkeypress="return isNumberKey(event)" placeholder="450" value="<?php test_extras_output($existing['extras'] ,'farm_size', $product_id,  'output');?>">
                                          ...
                                          <div class="control-group">
                                              <label class="control-label" for="electricity_supply">Electricity Supply</label>
                                              <div class="controls">
                                                  <select class="" name="electricity_supply">
                                                      <option value="">Select if Relevant</option>
                                          ...
                                          <div class="row-fluid">
                                              <div class="span6">
                                                  ...
                                                  <div class="control-group">
                                                      <label class="control-label" for="boreholes">No of Boreholes</label>

                                                      <div class="controls">
                                                          <input type="number" class="span10" id="boreholes" name="boreholes" placeholder="1"
                                                                 value="<?php test_extras_output($existing['extras'] ,'boreholes', $product_id,  'output');?>" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                                              ...
                                              <div class="span6">
                                                  <div class="control-group">
                                                      <label class="control-label" for="camps">No of Camps</label>

                                                      <div class="controls">
                                                          <input type="number" class="span10" id="camps" name="camps" placeholder="1"
                                                                 value="<?php test_extras_output($existing['extras'] ,'camps', $product_id,  'output');?>" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                                          ...
                                          <div class="row-fluid">
                                              <div class="span6">
                                                  <label class="control-label" for="game_camp">Game Camp?</label>
                                                  <div class="controls">
                                                      <input type="checkbox" name="game_camp" value="Game Camp" <?php test_extras_output($existing['extras'] ,'game_camp', $product_id,  'checked');?>>

                                                  </div>
                                              </div>
                                              <div class="span6">
                                                  <label class="control-label" for="waiver">Has a Waiver</label>
                                                  <div class="controls">
                                                      <input type="checkbox" name="waiver" value="Has a Waiver" <?php test_extras_output($existing['extras'] ,'waiver', $product_id,  'checked');?>>
                                                  </div>
                                              </div>
                                          ...
                                          <div class="row-fluid">
                                              <div class="span6">
                                                  ...
                                                  <div class="control-group">
                                                      <label class="control-label" for="external_fencing">External Fencing</label>

                                                      <div class="controls">
                                                          <select class="" name="external_fencing">
                                              ...
                                              <div class="span6">
                                                  <div class="control-group">
                                                      <label class="control-label" for="internal_fencing">Internal Fencing</label>

                                                      <div class="controls">
                                                          <select class="" name="internal_fencing">
                                          ...
                                          <div class="control-group">
                                              <label class="control-label" for="price_per_ha">Price per HA</label>
                                              <div class="controls">
                                                  <input type="number" name="price_per_ha" class="span6" placeholder="" value="<?php test_extras_output($existing['extras'] ,'price_per_ha', $product_id,  'output');?>">
                                                <span class="help-block"  style="font-size:11px">
                                      ...
                                      <div class="control-group">
                                        <label class="control-label" for="erf_size">Erf Size</label>
                                        <div class="controls">
                                                <input type="text" name="erf_size" onkeypress="return isNumberKey(event)" placeholder="450" value="<?php test_extras_output($existing['extras'] ,'erf_size', $product_id,  'output');?>">
                                                <select name="erf_size_">
                                      ...
                                      <div class="control-group">
                                        <label class="control-label" for="house_size">House Size</label>
                                        <div class="controls">
                                                <input type="text" name="house_size" onkeypress="return isNumberKey(event)" placeholder="350" value="<?php test_extras_output($existing['extras'] ,'house_size', $product_id,  'output');?>">
                                                <select name="house_size_">
                                      ...
                                      <div class="control-group">
                                          ...
                                          <label class="control-label" for="property_size">Property Size</label>
                                          <div class="controls">
                                              <input type="text" name="property_size" onkeypress="return isNumberKey(event)" placeholder="350" value="<?php test_extras_output($existing['extras'] ,'property_size', $product_id,  'output');?>">
                                              <select name="property_size_">
                                      ...
                                      <div class="control-group">
                                        <label class="control-label" for="parking">Parking and Garage</label>
                                        <div class="controls">
                                                <input type="text" name="parking" placeholder="2 Garages and outside parking" value="<?php test_extras_output($existing['extras'] ,'parking', $product_id,  'output');?>">
                                                <span class="help-block" style="font-size:11px">Please describe the garage and parking situation</span>
                                        </div>
                                      </div>           
                                      <div class="control-group">
                                            <label class="control-label" for="agency">Property Reference</label>
                                            <div class="controls">
                                                
                                                <input type="text" name="agency" value="<?php test_extras_output($existing['extras'] ,'agency', $product_id,  'output');?>" placeholder="Pam Golding">
                                                <span class="help-block"  style="font-size:11px">
                                               Your personal or private property reference. Unique property identification number eg: #REF453</span>
                                            </div>
                                       </div>
                                      <div class="control-group">
                                       ...
                                       <div class="control-group">
                                            <label class="control-label" for="features">Property Features</label>
                                            <div class="controls">
                                                ...
                                                <span class="help-block"  style="font-size:11px">
                                               What kind of features does the house have</span>
                                            </div>
                                       </div>
									  ...
									  { 			?>
                                          <div class="control-group">
                                           <label class="control-label" for="featured">Is the Property Featured</label>
                                                <div class="controls">
                                                    <div class="btn-group" data-toggle="buttons-radio">
                                                    ...
                                                    <input type="hidden" name="featured" id="toggle_featured" value="<?php if( $existing['featured'] == '0'){ echo 'N';} else{ echo $existing['featured'];}?>" />
                                                    <span class="help-block" style="font-size:11px">Should the property be displayed as a featured property?</span>
                                                    
                                                </div>
                                          </div>
                                          <div class="control-group">
                                              <label class="control-label" for="adjustment">Price Adjustment</label>
                                              <div class="controls">
                                                  <div class="btn-group" data-toggle="buttons-radio">
                                                  ...
                                                  <input type="hidden" name="adjustment" id="toggle_adjustment" value="<?php if( $existing['adjustment'] == '0'){ echo 'N';} else{ echo $existing['adjustment'];}?>" />
                               			...
                               			<div class="control-group">
                                            ...
                                            <div class="controls">
												<textarea  name="seller_contact" placeholder="Sellers Contact Details" cols="2" rows="4"><?php echo $existing['seller_contact'];?></textarea>
                                                <span class="help-block"  style="font-size:11px">
                                                The sellers contact details and other notes. NB only for your Reference!</span>
                                            </div>
                                       </div>
									  <?php 
