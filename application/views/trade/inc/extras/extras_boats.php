...
<div class="control-group">
  <label class="control-label" for="length"><strong>Length</strong></label>
  <div class="controls">
...
<div class="control-group">
  <label class="control-label" for="engine_type"><strong>Engine Type</strong></label>
  <div class="controls">
      <select class="form-control" name="engine_type" data-placeholder="Please Select" class="extra_slect form-control">
      ...
      <span class="help-block" style="font-size:11px">What type of engine powers the boat?</span>
  </div>
</div>
<br>

<div class="control-group">
      <label class="control-label" for="engine_hours"><strong>Engine hours</strong></label>
      <div class="controls">
          ...
          <span class="help-block"  style="font-size:11px">How many hours has the engine run?</span>
      </div>
 </div>
 <br>
...
<div class="control-group">
    ...
    <div class="controls">  
        ...
        <span class="help-block"  style="font-size:11px">How much cubic capacity is the engine in HP</span>
    </div>
</div>
<br>
...
<div class="control-group">
  <label class="control-label" for="owners"><strong>Number of Owners</strong></label>
  <div class="controls">
      ...
      <span class="help-block"  style="font-size:11px">How many people have owned the boat</span>
  </div>
</div> 
<br>

<?php 
//TEST IF AUTOHAUS - SHOW SPECIFICS
if($bus_id == 2666){
?>	
...
<div class="control-group">
      ...
      <div class="controls">
          <select name="autohaus[]" data-placeholder="Please Select" class="extra_slect" multiple="" size="6">
