...
<div class="row">
			...
			<div class="col-md-3">
                ...
                <div class="btn-group" data-toggle="buttons-radio">
                  <button type="button"  onclick="togglecheck(3409);" class="btn btn-inverse <?php if(isset($sub_cat_id) && $sub_cat_id != 0){ if($sub_cat_id == '3409'){echo 'active';}}else{ echo 'active';}?>"><i class="icon-home icon-white"></i> For Sale</button>
                  <button type="button" onclick="togglecheck(3410);" class="btn btn-inverse <?php if(isset($sub_cat_id)){ if($sub_cat_id == '3410'){echo 'active';}}else{ echo '';}?>"><i class="icon-share icon-white"></i> To Rent</button>
			...
			<div class="col-md-1">
            	<div class="clearfix hidden-tablet hidden-phone">&nbsp;</div>
                <p class="hidden-phone hidden-tablet"><strong>Next</strong> <i class="icon-forward"></i></p>
            </div>
			<div class="col-md-2">
            	<small>&nbsp;Land Type<i class="icon-question-sign pull-right" rel="tooltip" title="The property sectional type"></i></small>
                <select name="sub_sub_cat_id" id="sel_sub_sub_cat_id" class="col-md-12">
                	<?php 
            ...
            <div class="col-md-2">
				...
				<select name="sub_sub_sub_cat_id" id="sel_sub_sub_sub_cat_id" class="col-md-12" <?php if(!isset($sub_sub_cat_id) || $sub_sub_cat_id == 0){ echo 'disabled="disabled"';}?>>
                	<?php 
                ...
                <div class="col-md-2 room_div">
                        ...
                        <select class="col-md-12" name="bedrooms">
                ...
                <div class="col-md-2 room_div">
                      ...
                      <select class="col-md-12" name="bathrooms">
...
<div class="row-fluid">	
				...
				<div class="row-fluid">
                	<div class="col-md-6">
                        <div class="input-prepend input-append">
                          ...
                          <input name="price_from" type="text" placeholder="N$"  rel="tooltip" title="The minimum amount in N$" class="col-md-9" value="<?php if($price_from != 'n' && is_numeric($price_from)){ echo number_format($price_from);}?>">
                        </div>
                        		 	
					</div>
                    <div class="col-md-6">
                    	<small class="hidden-desktop hidden-tablet">&nbsp;</small>
                        <div class="input-append input-prepend">
                          <input name="price_to" type="text" placeholder="N$" rel="tooltip" title="The maximum amount to search for" class="col-md-9" value="<?php if($price_to != 'n' && is_numeric($price_to)){ echo number_format($price_to);}?>">
			...
			<div class="col-md-3">
				...
				<?php 	if($suburb != 'all'){
							...
							echo '<input type="hidden" name="suburb" value="all">
								<select id="suburb" class="col-md-12" disabled="disabled" placeholder="Select Suburb"></select>';
			...
			<div class="col-md-2 text-right">
            	...
            	<small class="hidden-desktop hidden-tablet">&nbsp;</small>
                <div class="btn-group">
                  <button class="btn btn-inverse hidden-tablet hidden-phone" type="button" id="toggle_feat_btn"><i class=" icon-chevron-down icon-white"></i></button>
