...
<div class="row-fluid">
        ...
        <form id="item-add" name="item-add" method="post" action="<?php echo site_url('/');?>trade/add_extras" class="form-horizontal">
                         <fieldset>
                                      ...
                                      <button type="submit" class="btn btn-inverse pull-right" id="add_extras_btn"><?php if (isset($product_id)){echo 'Update Item';}else{ echo 'Add Item';}?> <i class="icon-chevron-right icon-white"></i></button>
									  ...
									  ?>
                                      <a href="javascript:void(0)" onclick="back_to_all();" class="btn btn-inverse pull-right" style="margin-right:5px"><i class="icon-list icon-white"></i> All Products</a> 
