...
<script type="text/javascript">
  ...
  var BACKGROUND_IMAGE = '<?php echo S3_URL .'scratch_card/expo2013/prizes/'. $img_file;?>';
    ...
    function askDoneScratching()
    {
		...
		?>
			...
			$('#modal-win').bind('show', function() {
				...
				$('#win_msg').html('<img src="<?php echo S3_URL.'scratch_card/expo2013/prizes/'.$img_prize;?>" class="img-polaroid pull-left" style="width:60px;margin-right:20px;" />You have won. Go claim your voucher at the Warehouse Theatre opposite the Bank Windhoek tower and have a !na Day');
