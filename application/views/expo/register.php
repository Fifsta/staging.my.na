...
<form id="member-register" name="member-register" method="post" action="<?php echo site_url('/');?>expo/register_do_ajax" >
...
<!--              <div class="control-group">
              ...
              <button type="button" class="btn-large btn-inverse pull-right big_btn" name="submit" id="but" value="Join">Join My Na</button>
...
function submit_form(){
		...
		$.ajax({
			type: 'post',
			url: '<?php echo site_url('/').'expo/register_do_ajax';?>' ,
			data: frm.serialize(),
