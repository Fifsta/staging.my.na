...
<head>
	...
	<link rel="stylesheet" href="<?php echo S3_URL;?>scratch_card/expo2013/css/bootstrap.min.css">
...
<body>
   ...
   <!-- Part 1: Wrap all content here -->
    <div id="wrap">
    	<a href="<?php echo site_url('/');?>win/cymot/"><img src="<?php echo S3_URL;?>scratch_card/expo2013/images/refresh.png" style="position:fixed; right:20px; top:20px" /></a>
    	...
    	<img src="<?php echo S3_URL;?>scratch_card/expo2013/images/cymot.png" style="position:fixed; right:10px; bottom:10px" />
		<div class="container">
      ...
      <div id="game_stp1" class="container">
            ...
            <div class="row-fluid">
              	  ...
              	  <div class="span12 text-center">
                     <img src="<?php echo S3_URL;?>scratch_card/expo2013/images/front.jpg" style="margin-top:-20px" />
                     <div class="clearfix"></div>
                      <a class="btn btn-large btn-inverse big_btn" id="btn_login"> Login</a> 
                      <a class="btn btn-large btn-inverse big_btn" id="btn_register"> Register</a> 
                  </div> 
      ...
      <div id="game_stp3" class="container hide">
           ...
           <div class="row-fluid">
                   ...
                   <div class="span6 text-center" id="reg_form">
						...
						$this->load->view('expo/register' , $reg_data);?>
            ...
            <div class="row-fluid">
                   ...
                   <img src="<?php echo S3_URL;?>scratch_card/expo2013/images/play.png" />
                       ...
                       <div id="admin_content" style="width:100%; min-height:300px">
                          ...
                          <div id="scratch_content" style="width:100%" class="loading_img img-polaroid">
                           <img src="<?php echo S3_URL;?>scratch_card/expo2013/scratch_front_expo.png" rel="tooltip" title="Play Scratch and win"/> 
                          </div> 
...
<link href="<?php echo S3_URL;?>scratch_card/css/keyboard.css" rel="stylesheet" type="text/css" />   
<script type="text/javascript" src="<?php echo base_url('/');?>js/bootstrap-datepicker.js" ></script> 
<script src="<?php echo S3_URL;?>scratch_card/js/jquery.keyboard/jquery.keyboard.js"></script>
<script src="<?php echo S3_URL;?>scratch_card/js/jquery.keyboard/keyboards/azerty.js"></script>
<script src="<?php echo S3_URL;?>scratch_card/js/jquery.keyboard/keyboards/qwerty.js"></script>

<script src="<?php echo S3_URL;?>scratch_card/js/jquery.keyboard/plugins/form.js"></script>
<script src="<?php echoS3_URL;?>scratch_card/js/jquery.selection.js"></script>
...
$(document).ready(function() {
		  ...
		  $.ajax({
				...
				url: "<?php echo site_url('/');?>win/load_expo/"<?php //echo '+'. $rep_id;?>,
...
$("#btn_sign_in").bind("click touch", function(e){ 
	...
	$.ajax({
			  ...
			  cache: false,
			  data: frm.serialize(),
			  url: "<?php echo site_url('/');?>expo/login/",
			  success: function(data) {
