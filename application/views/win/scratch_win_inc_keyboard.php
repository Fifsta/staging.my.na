<script type="text/javascript" src="<?php echo base_url('/');?>scratch_card/js/jquery.idle-timer.js"></script>

<script type="text/javascript" src="<?php echo base_url('/');?>scratch_card/js/main.js"></script>
<script type="text/javascript" src="<?php echo base_url('/');?>scratch_card/js/ipad/scratcher.js"></script>

<script type="text/javascript">
  var BASE_PATH = '<?php echo base_url('/');?>scratch_card/expo2013';
  var USER_LOG_ID = '';
  
  function getBasePath() {
	  return BASE_PATH;
  }
  var BACKGROUND_IMAGE = '<?php echo base_url('/') .'scratch_card/expo2013/prizes/'. $img_file;?>';
...
//		window.location.href = '<?php echo site_url('/');?>win/expo/';
//	});
//	
    ...
    function askDoneScratching()
    {
		...
		?>
			...
			$('#modal-win').bind('show', function() {
				...
				$('#win_msg').html('<img src="<?php echo base_url('/').'scratch_card/expo2013/prizes/'.$img_prize;?>" class="img-polaroid pull-left" style="width:60px;margin-right:20px;" />You have won. Go claim your voucher at the Warehouse Theatre opposite the Bank Windhoek tower and have a !na Day');
				...
				removeBtn.unbind('click').click(function(e) { 
					...
					window.location.href = '<?php echo site_url('/');?>win/expo/<?php if(isset($rep_id)){ echo $rep_id;}else{ echo '0';} ?>';
			...
			$('#modal-win').bind('show', function() {
				...
				if($('#scratchPct').val() > 40){
					...
					removeBtn.unbind('click').click(function(e) { 
						...
						window.location = '<?php echo site_url('/');?>win/expo/<?php if(isset($rep_id)){ echo $rep_id;}else{ echo '0';} ?>';
...
//        });
    ...
    function initCard() {
        ...
        for (i = 0; i < scratchers.length; i++) {
            ...
            scratchers[i].setImages(BACKGROUND_IMAGE, BASE_PATH+'/scratch_front.png');
        }
...
<div class="card">
       <canvas id="scratcher1" width="780" height="485"></canvas>
</div>
