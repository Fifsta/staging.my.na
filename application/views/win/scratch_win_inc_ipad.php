    ...
    function askDoneScratching()
    {
		...
		?>
			...
			$('#modal-win').bind('show', function() {
				...
				$('#win_msg').html('<img src="<?php echo base_url('/').'scratch_card/expo2013/prizes/'.$img_prize;?>" class="img-polaroid pull-left" style="width:60px;margin-right:20px;" />Congratulations, you have won a fantastic prize from Cymot. Claim it now and have !na Day');
				...
				removeBtn.unbind('click').click(function(e) { 
					...
					window.location.href = '<?php echo site_url('/');?>volleyball/<?php if(isset($rep_id)){ echo $rep_id;}else{ echo '0';} ?>';
			...
			$('#modal-win').bind('show', function() {
				...
				if($('#scratchPct').val() > 40){
					...
					removeBtn.unbind('click').click(function(e) { 
						...
						window.location = '<?php echo site_url('/');?>volleyball/<?php if(isset($rep_id)){ echo $rep_id;}else{ echo '0';} ?>';
