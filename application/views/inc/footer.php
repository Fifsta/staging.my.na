    ...
    <div class="container">
        <div class="row text center text-light" style="padding:20px;">
          ...
          <span aria-hidden="true">&times;</span>
			...
			By closing this banner, accepting, clicking a link or continuing to browse otherwise, you agree to the use of cookies. <a href="javascript:void(0)" style="color:#ff9900">Accept</a> | <a href="javascript:void(0)" style="color:#ff9900">Do not Accept</a>
        </div>    
    </div>
</div> 
