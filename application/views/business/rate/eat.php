...
<form id="reviewfrm" name="reviewfrm" method="post" action="<?php echo site_url('/');?>rate/submit_review/<?php echo $bus_id;?>">
	...
	<div class="row">
		...
		<div class="col-xs-6 col-sm-4 col-md-3">
			<h4>Yumm factor</h4>
			<input name="YUMM_FACTOR" type="radio" value="1" class="star hide"/>
			<input name="YUMM_FACTOR" type="radio" value="2" class="star hide"/>
			<input name="YUMM_FACTOR" type="radio" value="3" class="star hide"/>
			<input name="YUMM_FACTOR" type="radio" value="4" class="star hide"/>
			<input name="YUMM_FACTOR" type="radio" value="5" class="star hide"/>
		...
		<div class="col-xs-6 col-sm-4 col-md-3">
			<h4>Atmosphere</h4>
			<input name="ATMOSPHERE" type="radio" value="1" class="star hide"/>
			<input name="ATMOSPHERE" type="radio" value="2" class="star hide"/>
			<input name="ATMOSPHERE" type="radio" value="3" class="star hide"/>
			<input name="ATMOSPHERE" type="radio" value="4" class="star hide"/>
			<input name="ATMOSPHERE" type="radio" value="5" class="star hide"/>
		</div>		
	</div>
	<hr> 
	<div class="row">
