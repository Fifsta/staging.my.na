			...
			<form id="reviewfrm" name="reviewfrm" method="post" action="<?php echo site_url('/');?>rate/submit_review/<?php echo $bus_id;?>">
				<div class="row-fluid">
					...
					<div class="span7">
						...
						<input name="UNIQUENESS" type="radio" value="1" class="star hide"/>
						<input name="UNIQUENESS" type="radio" value="2" class="star hide"/>
						<input name="UNIQUENESS" type="radio" value="3" class="star hide"/>
						<input name="UNIQUENESS" type="radio" value="4" class="star hide"/>
						<input name="UNIQUENESS" type="radio" value="5" class="star hide"/>
				...
				<div class="row-fluid">
					...
					<div class="span7">
						...
						<input name="FUN_FACTOR" type="radio" value="1" class="star hide"/>
						<input name="FUN_FACTOR" type="radio" value="2" class="star hide"/>
						<input name="FUN_FACTOR" type="radio" value="3" class="star hide"/>
						<input name="FUN_FACTOR" type="radio" value="4" class="star hide"/>
						<input name="FUN_FACTOR" type="radio" value="5" class="star hide"/>
