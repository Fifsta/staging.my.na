...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <style type="text/css">
			...
			*/
			#bodyTable{
				/*@editable*/ background-color:#E9DABB;
			}
			...
			*/
			#templatePreheader{
				/*@editable*/ background-color:#C33821;
...
<body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0" bgcolor="#E9DABB">
<?php 
//TEST]
//}?>
<?php $base = base_url('/');?>
            	...
            	<tr>
                	<td align="center" valign="top" id="bodyCell">
                    	...
                    	<table border="0" cellpadding="0" cellspacing="0" id="templateContainer">
                        	<tr>
                            	<td align="center" valign="top">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templatePreheader">
                                        <tr>
                                            <td valign="top" class="preheaderContent" style="padding-top:10px; padding-right:20px; padding-bottom:10px; padding-left:20px;color:#fff" mc:edit="preheader_content00">
                                               <?php if(isset($subject)){ echo $subject; }else{ echo 'My Namibia Mail, also known as !tna Mail';}?>
                                            </td>
                                            <!-- *|IFNOT:ARCHIVE_PAGE|* -->
                                            <td valign="top" width="180" class="preheaderContent" style="padding-top:10px; padding-right:20px; padding-bottom:10px; padding-left:0;" mc:edit="preheader_content01">
                                                  <?php if (isset($link)){?>
												  Email not displaying correctly?<br /><a href="<?php echo $link;?>" target="_blank">View it in your browser</a>.
                                                  <?php }else{?>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%"  id="templateHeader">
                                        <tr>
                                            <td valign="top" class="headerContent" style="margin:0;padding:0;background-color:#F4F4F4;border:none;">
                                            	<img src="<?php echo base_url('/');?>images/bground/email_banner_ntb1.jpg" style="max-width:600px; padding:0;margin:0" id="headerImage" alt="Download images to view"/>
                                            	<?php //if(isset($logo)){echo $logo; }else{ echo '<img src="'.base_url('/').'img/my-na-logo-black.png" style="float:left;width:auto;margin:10px 20px 15px 20px" />';}?>
                                            </td>
                                        </tr>
                                    </table>
                                    <!-- // END HEADER -->
                        	...
                        	<tr>
                            	<td align="center" valign="top">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%"  id="templateBody">
                                        <tr>
                                            <td valign="top" class="bodyContent" style="border:none;">
                            ...
                            <tr>
                              <td valign="top" style="padding-top:0;margin:0;padding:0;background-color:#000"><img src="<?php echo base_url('/');?>images/bground/email_bottom_shadow_ntb.jpg" style="max-width:600px;" alt="Download images to view"/></td>
                            </tr>
                        	<tr>
                            	<td align="center" valign="top">
                                	<!-- BEGIN FOOTER // -->
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateFooter">
                                        ...
                                        <tr>
                                          ...
                                          please click on the following link. <a href="<?php echo site_url('/')?>members/unsubscribe_daily/" style="font-size:10px; color: #FFF; text-decoration: underline; font-weight:bold;" >unsubscribe</a> <br />
    									  This email was sent with your permission from My Namibia, 8 Schinz Street Windhoek Namibia - +264 61 231 006</td>
                                        </tr>
