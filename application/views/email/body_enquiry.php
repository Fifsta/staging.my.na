...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <title>Business Enquiry My Namibia Email</title>
        ...
        <style type="text/css">
			...
			*/
			body, #bodyTable{
				/*@editable*/ background-color:#FF7401;
			}
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%"  id="templateHeader">
                                        <tr>
                                            <td valign="top" class="headerContent" style="margin:0;padding:0;background-color:#F4F4F4;border:none;">
                                            	<img src="<?php echo base_url('/');?>images/bground/email_banner.jpg" style="max-width:600px; padding:0;margin:0" id="headerImage" alt="Download images to view"/>
                            	...
                            	<td align="center" valign="top">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%"  id="templateBody">
                                        <tr>
                                            ...
                                            <h3>Sent from <em><?php echo $name;?></em> via the my.na website</h3>
											<blockquote><?php echo $msg;?></blockquote> 
 											<br />
                                            Name: <em><?php echo $name;?></em><br />
 											Email address: <em><?php echo $email;?></em><br /><br />
                                            You have received this enquiry via your business profile page on My Namibia.
											<br /><br />
                                            Manage your enquiries online at
                                            <a href="http://www.my.na/members/">http://www.my.na/members/</a>
                                            <br /><br /> 
