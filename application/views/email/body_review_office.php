...
<table width="100%"  bgcolor="#FF7401" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td bgcolor="#DBDBDB" style="background-color: #DBDBDB"><img src="http://my.na/NEW/img/icons/my-na-favicon.png" style="float:left;width:auto;margin:10px 20px 15px 20px" /></td>
  </tr>
  <tr>
...
<tr>
  <td colspan="2" style="font-family:Arial, Helvetica, sans-serif; font-size:16px;text-align:left;color:#666666; vertical-align:top">Hi, </td>
  </tr>
  <tr>
    <td colspan="2" style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#666666">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="2" style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#666666; text-align:left">One of our clients has been reviewed. Please make sure the review is publishable and doesnt contain any swear words or nasty language.</td>
  </tr>
  <tr>
    <td colspan="2" style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#666666; text-align:left">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="2" style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#666666; text-align:left">Review:</td>
  </tr>
  <tr>
    <td colspan="2" style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#666666; text-align:left"><?php echo $review;?><br/><br/><?php echo 'Rating: ' . $rating .' out of 10';?></td>
  </tr>
  <tr>
    <td colspan="2" style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#666666; text-align:left">&nbsp;</td>
  </tr>
  ...
  <tr>
    <td colspan="2" style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#666666; text-align:left"><em><strong>My Namibia</strong></em></td>
  </tr>
