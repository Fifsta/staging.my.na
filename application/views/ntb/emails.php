    ...
    <div id="container-body" class="container" style="margin-top:80px;">
        ...
        <div class="row">
            ...
            <div class="span12">
                ...
                <h1>NTB <small>Compose a Newsletter</small></h1>
        ...
        <div class="row-fluid">
            <form id="sendmail" target="load_frame" name="sendmail" method="post"
                  action="<?php echo site_url('/'); ?>ntb/send_email">
                <div class="span4">
                    ...
                    <div>
                        <ul class="nav nav-tabs nav-stacked">
                            ...
                            <li><a href="<?php echo site_url('/'); ?>ntb/build_mail/">Compose Newsletter<i
                                        class="icon-chevron-right pull-right"></i></a></li>
                            <li class="active"><a href="<?php echo site_url('/'); ?>ntb/emails/">Newsletters<i
                                        class="icon-chevron-right pull-right"></i></a></li>
...
//        /select_rec('business');
    ...
    function compose_email(id) {
        ...
        if (test_save()) {
            ...
            window.location.href = '<?php echo site_url('/'). 'ntb/compose_email/';?>'+id;
    ...
    function get_emails(str) {
        ...
        if (test_save()) {
            ...
            $.get('<?php echo site_url('/'). 'ntb/get_emails/';?>' + str, function (data) {
