        ...
        <div class="col-md-12">
          ...
          <section id="listing">
            ...
            <div class="list-map">
              ...
              <div class="list-map-right hidden-xs-down" id="map_container">
            ...
            <div class="tab-content">
              ...
              <section role="tabpanel" class="tab-pane" id="Gallery">
                ...
                <p class="muted">Browse one or more images by clicking on the "Browse" button, then upload these images by clicking on the "Add Images" button</p>
                <div class="row">
            ...
            <ul class="nav nav-tabs" role="tablist">
              ...
              <li role="presentation" class="nav-item"><a href="<?php echo site_url('/').'sell/index/'.$bus_id; ?>" class="nav-link pbtn"  data-icon="fa-plus"><span class="d-sm-none">Add</span></a></li>
            </ul>
