...
<head>
	...
	<title>My Namibia - Verify Your Account</title>
	...
	<div id="home-bak" style="padding-top:0;width:100%;height:100%;bottom:0;">
		<div class="container" style="position:relative;z-index:999;">
			...
			<div class="control-group">
				...
				<input type="text" id="cell" name="number" style="margin-top:10px; width:95%" class="span2" placeholder="eg: 0811234567" value="<?php if (isset($CLIENT_CELLPHONE))
				{
			...
			else
			{
				...
				<input type="text" class="input-block-level" placeholder="Email" name="passemail" value="<?php if (isset($email))
				{
					echo $email;
				} ?>"/>
