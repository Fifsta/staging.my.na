...
|
*/
$config['rest_realm'] = 'My Namibia REST API';
...
$config['auth_override_class_method']['gipf']['send'] = 'digest';
//$config['auth_override_class_method']['gipf']['send'] = 'digest';
/*
|--------------------------------------------------------------------------
...
|
*/
$config['rest_valid_logins'] = array('my_info' => '$5_jh56_hdgd');
//$config['rest_valid_logins'] = array('myna_ma$ster' => '#$5_jh56_hdgd', 'admin' => '1234');
/*
|--------------------------------------------------------------------------
