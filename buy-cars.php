				...
				<section id="results">
					...
					<div class="row">
						<div id="filter" class="col-sm-12">
							<form>
								<div class="col-sm-4 input-group input-group-lg">
									<div class="input-group-addon" data-icon="fa-cab">Type:</div>
									<select class="selectpicker form-control" data-live-search="true" data-none-selected-text="Select type of car">
								...
								<div class="col-sm-4 input-group input-group-lg">
									<div class="input-group-addon" data-icon="fa-industry">Manufacturer:</div>
									<select class="selectpicker form-control" data-live-search="true" data-none-selected-text="Select manufacturer">
								...
								<div class="col-sm-4 input-group input-group-lg">
									<div class="input-group-addon" data-icon="fa-car">Model:</div>
									<select class="selectpicker form-control" data-live-search="true" data-none-selected-text="Select model">
								...
								<div class="col-sm-4 input-group input-group-lg">
									<div class="input-group-addon" data-icon="fa-history">Year:</div>
									<select class="selectpicker form-control" data-live-search="true" data-none-selected-text="Select year">
								...
								<div class="col-sm-4 input-group input-group-lg">
									<div class="input-group-addon" data-icon="fa-fire">Fuel:</div>
									<select class="selectpicker form-control" data-live-search="true" data-none-selected-text="Select fuel type">
								...
								<div class="col-sm-4 input-group input-group-lg">
									<div class="input-group-addon" data-icon="fa-map-marker">Near:</div>
									<select class="selectpicker form-control" data-live-search="true" data-none-selected-text="Select location">
								...
								<div class="col-sm-4 input-group input-group-lg">
									<div class="input-group-addon">From N$:</div>
									<select class="selectpicker form-control" data-live-search="true" data-none-selected-text="Select minimum price ...">
								...
								<div class="col-sm-4 input-group input-group-lg">
									<div class="input-group-addon">To N$:</div>
									<select class="selectpicker form-control" data-live-search="true" data-none-selected-text="Select maximum price ...">
						...
						<div class="results-head col-sm-12">
							...
							Sort by:
							<button class="btn btn-default btn-sm">Manufacturer <i class="fa fa-sort"></i></button>
