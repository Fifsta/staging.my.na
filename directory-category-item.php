		...
		<div class="row content">
			...
			<div class="left col-sm-8 col-md-9">
				<section id="listing">
					<div class="row">
						<div class="heading">
							<h2 data-icon="fa-bed">Avani windhoek Hotel &amp; Casino</h2>
							<ul class="options">
								<li><a href="#About" data-icon="fa-info">About</a></li>
								<li><a href="#Enquiry-Form" data-icon="fa-envelope-o">Enquiry Form</a></li>
								<li><a href="#Deals" data-icon="fa-certificate">Deals</a></li>
								<li><a href="#Activities" data-icon="fa-bicycle">Activities</a></li>
								<li><a href="#Gallery" data-icon="fa-file-photo-o">Gallery</a></li>
							...
							<div class="details-right">
								...
								<div class="row reveal">
									...
									<div class="col-sm-12 col-md-6">
										...
										<p data-icon="fa-globe"><a href="http://www.website.com.na" class="btn btn-default" target="_blank"><!--W: -->www.website.com.na</a></p>
									</div>
								</div>
							</div>
						</div>
				...
				<section id="results">
					<div class="row">
						<div class="heading">
							<h2><strong>Similar</strong> Accommodation</h2>
				...
				<section id="deals">
					...
					<div class="row">
						<div class="heading">
							<h2>Accommodation <a href="#"><strong>Deals</strong></a></h2>
							<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
							<ul class="options">
				...
				<section id="auctions">
					...
					<div class="row">
						<div class="heading">
							<h2>Accommodation <a href="#"><strong>Auctions</strong></a></h2>
							<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
							<ul class="options">
								<li><a href="#" data-icon="fa-edit">List my own</a></li>
								<li><a href="#" data-icon="fa-bullhorn">Alert me</a></li>
