		...
		<div class="row content">
			...
			<div class="right col-sm-4 col-md-3 pull-right">
				...
				<section class="sidenav">
					...
					<nav class="profile">
						<h2 class="hidden">Notificatios</h2>
			...
			<div class="left col-sm-8 col-md-9">
				<section id="listing">
					<div class="row">
						<div class="heading">
							<h2 data-icon="fa-car">Audi A3</h2>
							<ul class="options">
								<li><a href="#Contact-Agent" data-icon="fa-envelope-o">Contact Agent</a></li>
								<li><a href="#Reviews" data-icon="fa-star-o">Reviews</a></li>
								<li><a href="#" data-icon="fa-facebook"></a></li>
								<li><a href="#" data-icon="fa-twitter"></a></li>
								<li><a href="#" data-icon="fa-bookmark"></a></li>
							</ul>
						</div>
					</div>
					<div class="row" style="position:relative">
						...
						<div class="list-map">
							<div class="list-map-left">
								<div class="swipe js-flickity" data-flickity-options='{ "cellSelector":".swipe-item", "wrapAround": false, "lazyLoad":true, "prevNextButtons":true, "pageDots":false, "cellAlign":"left", "contain":true }'>
									...
									<div class="swipe-item">
										<figure><a href="#"><img src="images/listing-placeholder.jpg"></a></figure>
									</div>
									<div class="swipe-item">
										<figure><a href="#"><img src="images/listing-sample.jpg"></a></figure>
									</div>
									<div class="swipe-item">
										<figure><a href="#"><img src="images/listing-sample.jpg"></a></figure>
									</div>
						...
						<div class="details">
							<div class="details-left">
								<figure>
									<a href="#"><img src="images/logo-placeholder.jpg"></a>
								</figure>
								<div class="rating">
							...
							<div class="details-right">
								<h2>Audi A3 <span>Listed 3 days ago</span><a href="#" data-toggle="tooltip" title="Find out more about getting featured"><span>Featured</span></a></h2>
								<p class="cost">N$ 489,990.00</p>
								...
								<div class="feat">
									<div><strong>Year:</strong> Late 2016</div>
									<div><strong>Milage:</strong> 80 000Km</div>
									<div><strong>Fuel:</strong> Diesel</div>
									<div><strong>Transmission:</strong> Late 2016</div>
									<div><strong>Color:</strong> Silver</div>
									<div><strong>Engine:</strong> 6 cylinders </div>
									<div><strong>Engine Size:</strong> 3,000</div>
									<div><strong>Warranty:</strong> Yes</div>
									<div><strong>Owners:</strong> 1</div>
								</div>
							</div>
						</div>
						<!--details-->
						...
						<ul class="nav nav-tabs" role="tablist">
							<li class="active" role="presentation"><a href="#Contact-Agent" aria-controls="Contact-Agent" role="tab" data-toggle="tab" data-icon="fa-envelope-o">Contact Agent</a></li>
						</ul>
								...
								<div class="row">
									<div class="col-sm-12">
										<section class="results-item">
											...
											<div>
												<h2><a href="#">Lionel McPherson</a> from <a href="#">Spes Bona Motor Company</a> <a href="#" data-toggle="tooltip" title="Find out more about getting featured"><span>Featured</span></a></h2>
												<p class="addr" data-icon="fa-map-marker"><a class="fancy-media" href="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3684.8309378265176!2d17.08688731495913!3d-22.548004985195448!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1c0b1b39455cc893%3A0xa8e7e9ba0305001a!2sIntouch+interactive+Marketing!5e0!3m2!1sen!2sna!4v1473690598478">129 Independence Avenue, Gustav Voigts Centre</a>, <a href="#">Windhoek</a></p>
												<p class="desc">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. </p>
												<div class="row reveal">
													<div class="col-sm-12 col-md-6">
														<p data-icon="fa-phone"><button class="btn btn-default"><!--T: -->+264 64 123 426</button></p>
														<p data-icon="fa-fax"><button class="btn btn-default"><!--F: -->+264 64 123 426</button></p>
													</div>
													<div class="col-sm-12 col-md-6">
														<p data-icon="fa-tablet"><button class="btn btn-default"><!--C: -->+264 81 123 4026</button></p>
													</div>
												</div>
											</div>
											<div>
												<div class="revi">
													<a href="#" class="btn btn-default btn-block">View all agency products (3)</a>
													<a href="#" class="btn btn-default btn-block">View all agent products (1)</a>
												</div>
											</div>
										</section>
									</div>
						...
						<ul class="nav nav-tabs" role="tablist">
							...
							<li role="presentation"><a href="#Question" aria-controls="Question" role="tab" data-toggle="tab" data-icon="fa-question">Ask a Question</a></li>
						</ul>
						<div class="tab-content">
							...
							<section role="tabpanel" class="tab-pane" id="Question">
								<div class="row">
									<div class="col-sm-8">
										<h2 class="tab-head">Asked Questions</h2>
										...
										<div class="review-item">
											<div class="row">
												...
												<div class="col-sm-10 col-md-10">
													<blockquote>
														<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
														<footer data-icon="fa-question-circle">Question by: Carl-Heinz Benseler <span>2 years ago</span></footer>
													</blockquote>
												</div>
											</div>
											...
											<div class="row" style="margin-left:20px">
												...
												<div class="col-sm-10 col-md-10">
													<blockquote>
														<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
														<footer data-icon="fa-exclamation-circle">Answer by: Carl-Heinz Benseler <span>2 years ago</span></footer>
													</blockquote>
												</div>
											</div>
										</div>
				...
				<section id="results">
					<div class="row">
						<div class="heading">
							<h2><strong>Similar</strong> Cars, Bikes and Boats</h2>
				...
				<section id="deals">
					...
					<div class="row">
						<div class="heading">
							<h2>Cars, Bikes and Boats <a href="#"><strong>Deals</strong></a></h2>
				...
				<section id="auctions">
					...
					<div class="row">
						<div class="heading">
							<h2>Cars, Bikes and Boats <a href="#"><strong>Auctions</strong></a></h2>
							<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
							<ul class="options">
								<li><a href="#" data-icon="fa-edit">List my own</a></li>
								<li><a href="#" data-icon="fa-bullhorn">Alert me</a></li>
		...
		<div class="footer-end">
			<div class="container">
				...
				<ul>
					<li><a href="#" data-icon="fa-facebook"></a></li>
					<li><a href="#" data-icon="fa-twitter"></a></li>
					<li><a href="#" data-icon="fa-youtube"></a></li>
				</ul>
