...
function loadme(id,e ,bus_id){
	...
	if(bus_id != 0){
        ...
        div.html('<a href="javascript:minimizeme(0);" id="widget_btn_min" class="close" style="position:absolute;float:right;margin:0;width:170px"><img src="https://www.my.na/img/icons/plus.png?v1" id="min_max_icon" style="margin-top:10px;padding:0;"></a><iframe style="display:block;height:100%;width:100%;overflow:hidden" allowtransparency="true" frameborder="0" src="'+base_url+'rate/rateme/'+bus_id+'/plugin/'+ext+'/show/"></iframe>');
...
function minimizeme(str){
	...
	if(str == 'min'){
		...
		var container = $('#place_hold_div_my_na').css({"height":"410px", "width":"481px"});
