		...
		<div class="row content">
			...
			<div class="left col-sm-8 col-md-9">
				<section id="listing">
					<div class="row">
						<div class="heading">
							<h2 data-icon="fa-bicycle">Desert Quad Explorers</h2>
							<ul class="options">
								<li><a href="#About" data-icon="fa-info">About</a></li>
								<li><a href="#Offered-by" data-icon="fa-building-o">Offered by</a></li>
					...
					<div class="row" style="position:relative">
						...
						<ul class="nav nav-tabs" role="tablist">
							...
							<li role="presentation"><a href="#Offered-by" aria-controls="Offered-by" role="tab" data-toggle="tab" data-icon="fa-building-o">Offered by</a></li>
						...
						<div class="tab-content">
							...
							<section role="tabpanel" class="tab-pane" id="Offered-by">
								<h2 class="tab-head">Offered by</h2>
								<div class="row">
									<div class="col-sm-12">
						...
						<!--tabs-->
						<ul class="nav nav-tabs" role="tablist">
							<li role="presentation" class="active"><a href="#Reviews" aria-controls="Reviews" role="tab" data-toggle="tab" data-icon="fa-star-o">Reviews</a></li>
								...
								<div class="row review-item">
									...
									<div class="col-sm-10 col-md-5">
										<blockquote>
											...
											<header>An amazing experience</header>
				...
				<section id="results">
					<div class="row">
						<div class="heading">
							<h2 data-icon="fa-search"><strong>Similar</strong> Things To Do</h2>
							<p>Want to list your activities here? <a href="#">Try it out for free!</a></p>
						</div>
					</div>
					<div class="row">
